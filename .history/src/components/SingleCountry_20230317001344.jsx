...
const SingleCountry = () => {
  ...
  const { singleCountryData, loading } = useSelector((state) => state.country);
  ...
  useEffect(() => {
    ...
    setCountry({
      ...country,
      officialName: singleCountryData?.name?.official,
      commonName: singleCountryData?.name?.common,
      continents: singleCountryData?.continents,
      flag: singleCountryData?.flags?.svg,
      population: singleCountryData?.population,
      capital: singleCountryData?.capital || singleCountryData?.name.common,
      currencies: singleCountryData?.currencies,
      languages: singleCountryData?.languages,
      borders: singleCountryData?.borders,
    });
  }, []);
