      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 mx-8">
        <figure>
          <img
            ...
            src={singleCountryData[0].flags?.svg}
            alt={singleCountryData[0].flags?.alt}
          />
          <div className="mt-4">
        ...
        <div>
          <ul>
            <li>
              ...
              {singleCountryData[0].continents}
            </li>
            <li>
              <span className="inline-block w-[160px] font-bold mb-3">
                Capital:
              </span>
              {singleCountryData[0].capital || "***"}
            </li>
            ...
            <li>
              ...
              {singleCountryData[0].population?.toLocaleString()}
            </li>
            <li>
              <span className="inline-block w-[160px] font-bold mb-3">
                Currency/ies:
              ...
              <span className="overflow-x-scroll">
                {singleCountryData[0].currencies
            ...
            <li>
              ...
              {singleCountryData[0].languages
                ? Object.values(singleCountryData[0].languages)
                    .map((el) => el)
                    .join(", ")
                : "***"}
            </li>
