...
const SingleCountry = () => {
  ...
  const clickBorderHandler = (border) => {
    nav(`/${border}`, { replace: false });
  };
    ...
    <div className="max-w-[1200px] my-16 mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 mx-8">
        ...
        <Weather
          ...
          temp={Number(weather.temp - 273.15).toFixed(0)}
          tempMin={Number(weather.tempMin - 273.15).toFixed(0)}
          tempMax={Number(weather.tempMax - 273.15).toFixed(0)}
