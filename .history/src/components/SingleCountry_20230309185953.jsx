...
const SingleCountry = () => {
  ...
  //   axios
  //     .get(
  //       `https://api.openweathermap.org/data/2.5/weather?q=${country[0]?.capital}&appid=645c2dc9bdf404bc19b5ee2818538af9`
  //     )
  //     .then((res) => setWeather({...weather, temp: res.data?.main?.temp, tempMin: res.data?.main?.temp_min, tempMax: res.data?.main?.temp_max}));
  // }, []);
  ...
  return (
    <div className="max-w-[1200px] my-16 mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 mx-8">
        ...
        <Weather name={country.commonName} />
      </div>
    </div>
  );
};
