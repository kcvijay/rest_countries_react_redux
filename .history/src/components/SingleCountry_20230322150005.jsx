    ...
    <div className="max-w-[1200px] my-16 mx-auto">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 mx-8">
        ...
        <Weather
          ...
          temp={
            weather?.main?.temp
              ? Object.values(weather?.main?.temp - 273.15).toFixed(0)
              : "_"
          }
          tempMin={
            weather?.main?.temp_min
              ? Object.values(weather?.main?.temp_min - 273.15).toFixed(0)
              : "_"
          }
          tempMax={
            weather?.main?.temp_max
              ? Object.values(weather?.main?.temp_max - 273.15).toFixed(0)
              : "_"
          }
          condition={
            weather?.weather[0]?.description
              ? Object.values(weather?.weather[0]?.description)
              : "_"
          }
          icon={weather?.weather[0]?.icon ? weather?.weather[0]?.icon : "_"}
          visibility={
            weather?.visibility ? weather?.visibility / 1000 + " km" : "_"
          }
          wind={weather?.wind?.speed ? weather?.wind?.speed + " m/sec" : "_"}
        />
      </div>
