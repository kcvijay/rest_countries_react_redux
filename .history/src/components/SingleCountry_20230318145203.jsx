...
const SingleCountry = () => {
  ...
  useEffect(() => {
    ...
    setCapital(countryData[0].capital[0]);
    // dispatch(getWeather(countryData[0]?.capital[0]));
  }, [params]);
  console.log(capital);

  useEffect(() => {
    const response = axios.get`https://api.openweathermap.org/data/2.5/weather?q=${capital}&appid=645c2dc9bdf404bc19b5ee2818538af9`;
