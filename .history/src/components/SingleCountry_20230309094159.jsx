...
const SingleCountry = () => {
  ...
  //   axios
  //     .get(
  //       `https://api.openweathermap.org/data/2.5/forecast?lat=${country[0]?.latlng[0]}&lon=${country[0]?.latlng[1]}&appid=645c2dc9bdf404bc19b5ee2818538af9`
  //     )
    ...
    <div className="max-w-[1200px] my-16 mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 mx-8">
        <figure>
          ...
          <img
            className="shadow-md max-h-[240px] max-w-[350px] object-fill"
